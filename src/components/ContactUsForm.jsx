...
export default function ContactUsForm() {
	...
	const handleSubmit = async (event) => {
		...
		try {
			...
			alert.error(
				"Something went wrong! Refresh the page or give us a call."
			);
		}
		setLoading(false);
	};
	...
	return (
		<div className="container bg-secondary card shadow p-3 mb-2 mt-2">
			...
			<p className="text-dark" style={{ fontWeight: "bold" }}>
				Got a question? Want a quote? Got some feedback? Don&apos;t
				hesitate to get in contact and we will be happy to help. Thank
				you!
			</p>
			<hr />
			<div className="contactUs text-warning font-weight-bold ">
				<Form onSubmit={handleSubmit}>
					...
					<Button
						className="btn btn-warning my-2 my-md-2"
						type="submit"
					>
						{loading && (
							<Spinner
