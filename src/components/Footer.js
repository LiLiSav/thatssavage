    ...
    return (
        <div className="footer-row-number footer-spacing">
            <a href='tel:+353872105305' className='text-light nav-link'>
                <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-telephone-fill text-warning" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const Address=()=> {
    return (
        <a className="text-light nav-link footer-spacing" href="https://goo.gl/maps/gv5ke2gXp7STHdPe7" target="_blank" rel="noreferrer">
