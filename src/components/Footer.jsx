...
const SocialMediaButtons = () => {
	return (
		<div className="footer-spacing">
			<a
				href="https://www.facebook.com/thatssavage/"
				target="_blank"
				rel="noreferrer"
			>
			...
			<a
				href="https://www.instagram.com/thatssavage.print/?hl=en"
				target="_blank"
				rel="noreferrer"
			>
			...
			<a
				href="https://www.linkedin.com/in/declan-savage-a972b424/?originalSubdomain=ie"
				target="_blank"
				rel="noreferrer"
			>
...
const Address = () => {
	return (
		<a
			className="text-light nav-link footer-spacing"
		...
		<nav className="footer-container">
			<div className="footer-items">
				...
				<div className="footer-row order-3">
					<h5
						className="footer-header centered"
