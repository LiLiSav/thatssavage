export default function Terms() {
  return (
    <div className="container shadow p-5 mb-3 mt-3 card">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Thatssavage,
            Carrickaderry, Clontibret, Co. Monaghan.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Thatssavage, accessible from{" "}
            <a
              href="http://www.thatssavage.ie"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              http://www.thatssavage.ie
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: thatssavage@gmail.com</li>
      </ul>
    </div>
  );
}
